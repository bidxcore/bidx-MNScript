...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='bidx.conf'
CONFIGFOLDER='/root/.bidx'
COIN_DAEMON='/usr/local/bin/bidxd'
COIN_CLI='/usr/local/bin/bidx-cli'
COIN_REPO='https://github.com/bidxcore/bidx'
COIN_NAME='BIDX'
COIN_PORT=40000
RPC_PORT=10727

NODEIP=$(curl icanhazip.com)
...
function compile_node() {
  ...
  compile_error
  cp usr/local/bin/bidx* /usr/local/bin
  compile_error
...
function create_key() {
  echo -e "${BLUE}■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■${NC}"
  echo -e "Enter your ${RED}$COIN_NAME Masternode Private Key${NC} below. :"
  read -e COINKEY
  echo -e "${BLUE}■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■${NC}"
  if [[ -z "$COINKEY" ]]; then
  $COIN_DAEMON -daemon
...
function get_ip() {
  ...
  do
    NODE_IPS+=($(curl --interface $ips --connect-timeout 2 curl icanhazip.com))
  done
